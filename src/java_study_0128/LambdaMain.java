...
//매개변수가 있고 리턴 타입이 없는 경우 : 원본에 작업을 해서 원본을 변환 인터페이스 
...
public class LambdaMain {
	...
	public static void main(String[] args) {
		...
		NoArgNoReturn ob1 = () -> {
			System.out.println("매개변수가 없고 리턴도 없는 람다");
		};
		ob1.method1();

		
		// 매개변수가 있는 경우 - 매개변수의 자료형은 생략이 가능, 매개변수가 1개인경우는( )로 감싸지 않아도 됩니다.
		ArgNoReturn ob2 = (int x) -> {
			System.out.println(x + 10);
		}; // 자료형을 안써도됨 int 생략가능
		ob2.method2(100);
		

		// 매개변수는 없고 리턴만 있는경우 -거의 없음
		NoArgReturn ob3 = () -> {
			return 10.3;
		};
		...
		consumer.accept("Java Lamdba");
		

		// Function 인터페이스는 매개변수가 1개이고 리턴타입이 있는 메소드를 소유
		// 제네릭에서 앞의 자료형은 매개변수의 자료형이고 뒤의 자료형은 리턴타입의 자료형
