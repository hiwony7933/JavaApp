...
public class practice_multi_dimensional_array {

	public static void main(String[] args) {
		// 초기 데이터를 가지고 이차원 배열생성
		String[][] players = { { "이종범", "윤석민", "안치홍" }, { "박병호", "김하성", "이정후" } };
		...
		System.out.println("================");
		// 이차원 배열 중에서 모든 행의 열 개수가 동일하다면 하나의 반복문으로 모든 데이터 접근 가능
